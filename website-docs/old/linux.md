---
title: "How to connect to Enjuu (Linux)"
old_id: 14
---
This guide is only for connecting osu! to Enjuu, and not setting the game itself up. You can follow [this guide](https://gist.github.com/Francesco149/a2f796683a4e5195458f4bb171d88eb0) to set the client up.
...
Download the certificate by clicking [*here*](https://git.zxq.co/Enjuu/Enjuu-server-switcher/raw/master/EnjuuServerSwitcher/Resources/certificate.cer)
...
Click *Browse...* then select the Enjuu certificate.
...
After that is done, you can start the client up, and log in with your Enjuu credentials.