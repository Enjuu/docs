...
3. Don't **spam or flood**, unless you're occasionally sending a link to e.g. Twitch when you're streaming Enjuu when no discussion is going on.
...
#### _This is how we handle cheaters and multiaccounters on Enjuu._

1. Cheating and multiaccount is strictly prohibited.
2. It doesn't matter if you cheated on any other osu! server - we only care about what you did on Enjuu.
3. Multiaccounts are **NOT** allowed, with the **SOLE EXCEPTION OF CHAT BOTS**.  If you are developing one and need an account for it,  mail [support](mailto:support@enjuu.click) (or a [dev](mailto:howl@enjuu.click))
4. We reserve the right to change these rules as we see fit.

<h3><i class="list layout icon"></i> Miscellaneous</h3>

1. You can change your profile flag mailing [support](mailto:support@enjuu.click), and sending a picture with a valid document and a post-it or a piece of paper with your Enjuu name.
2. Name changes are handled through our [support website.](https://support.enjuu.click)
